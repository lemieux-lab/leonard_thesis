...
include("engines/linear_regression.jl")
...
col, alpha, ms_size, strk_w = :black, 0.1, 3, 0
scatter!(ax_FE, FE_space_dists[FE_space_dists .!= 0], orig_space_dists[orig_space_dists .!= 0], color = (col,alpha),markersize=ms_size)
# hexbin!(ax_FE, FE_space_dists[FE_space_dists .!= 0], orig_space_dists[orig_space_dists .!= 0], bins = 200)
a = add_linear_reg!(ax_FE, FE_space_dists[FE_space_dists .!= 0], orig_space_dists[ orig_space_dists .!= 0])
fig
...
ylabel = "Gene Expression distance (19962 genes)")
fig
scatter!(ax_UMAP, UMAP_space_dists[UMAP_space_dists .!= 0], orig_space_dists[orig_space_dists .!= 0], color = (col,alpha),markersize=ms_size)
# hexbin!(ax_UMAP, UMAP_space_dists[UMAP_space_dists .!= 0], orig_space_dists[orig_space_dists .!= 0], bins = 150)
a = add_linear_reg!(ax_UMAP, UMAP_space_dists[UMAP_space_dists .!= 0], orig_space_dists[ orig_space_dists .!= 0])
...
scatter!(ax_FE_50D, FE_50D_space_dists[FE_50D_space_dists .!= 0],FE_50D_orig_space_dists[FE_50D_orig_space_dists .!= 0], color = (col,alpha), markersize=ms_size)

# hexbin!(ax_FE_50D, FE_50D_space_dists[FE_50D_space_dists .!= 0], FE_50D_orig_space_dists[FE_50D_orig_space_dists .!= 0], bins = 150)
a = add_linear_reg!(ax_FE_50D, FE_50D_space_dists[FE_50D_space_dists .!= 0],FE_50D_orig_space_dists[FE_50D_orig_space_dists .!= 0])
fig
...
scatter!(ax_UMAP_50D, UMAP_50D_space_dists[UMAP_50D_space_dists .!= 0], UMAP_50D_orig_space_dists[UMAP_50D_orig_space_dists .!= 0], color = (col,alpha),markersize=ms_size)
