...
generate_params(X_data, emb_size) = return Dict( 
    ...
    ## optim infos 
    "lr" => 1e-2, "l2" => 1e-8,"nsteps" => 30_000, "nsteps_inference" => 10_000, "nsamples_batchsize" => 4,
    ## model infos
...
params = generate_params(X_data, embs)
# save IDs
trained_FE,  tr_epochs , tr_loss, tr_cor =  generate_patient_embedding(X_data, samples[train_ids], genes[CDS], params, labs[train_ids])
